...
def launch(context, *args, **kwargs): 
    return [
        ...
        Node(
            ...
            arguments=['--x', '0', '--y', '0', '--z', '2', '--roll', '0', '--pitch', '0', '--yaw', '0', '--frame-id', 'wamv/base_link', '--child-frame-id', 'imu'],
            output='screen'
        ),
        Node(
            package='tf2_ros',
            ...
            arguments=['--x', '0', '--y', '0', '--z', '2', '--roll', '0', '--pitch', '0', '--yaw', '0', '--frame-id', 'wamv/base_link', '--child-frame-id', 'gps'],
            output='screen'
        )
    ]
